...
const far = (await req('/content', 'POST', { title: 'x44: far ahead reel', channels: ['youtube'], type: 'reel', release_date: day(10), status_id: sid(/^editing$/i) })).data
await req('/content', 'POST', { title: 'x44: shooting tomorrow', channels: ['youtube'], type: 'reel', recording_date: day(1), release_date: day(10), status_id: sid(/^editing$/i) })
await req('/content', 'POST', { title: 'x44: dateless reel', channels: ['youtube'], type: 'reel', status_id: sid(/^editing$/i) })
...
await req('/content', 'POST', { title: 'x44: shot slipped', channels: ['youtube'], type: 'reel', recording_date: day(-2), release_date: day(6), status_id: sid(/^editing$/i) })
await p.reload(); await p.waitForTimeout(1400)
