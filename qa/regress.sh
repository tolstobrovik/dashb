...
for s in dash-suite brief-suite role-suite polish-suite programs-suite lens-dark-suite polish2-suite round-suite round3-suite round4-suite round5-suite round6-suite round7-suite round8-suite round9-suite round10-suite round11-suite round12-suite round13-suite round14-suite round15-suite round16-suite round17-suite round19-suite; do
