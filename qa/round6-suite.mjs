...
const opOptions = await page.locator('.modal .crew-field select').first().locator('option').allTextContents()
ok('operator list holds operator-role people only', opOptions.some((o) => o.includes('Round Six Operator'))
  && !opOptions.some((o) => o.includes('Jasmina') || o.includes('Mirabbos') || o.includes('Aziza')), opOptions.join(' | '))
