...
await req('/content', 'POST', { title: 'x25: gap video', channels: ['youtube'], type: 'video' })
await req('/content', 'POST', { title: 'x25: late post', channels: ['instagram_main'], type: 'post', assignees: [jas.id], designer_id: jas.id, release_date: iso(-1) })
