...
const orphan = (await req('/content', 'POST', { title: 'x24: orphan video', channels: ['youtube'], type: 'video', status_id: shootId, operator_id: 1, recording_date: '2031-03-03', edit_ready_date: '2031-03-05', release_date: '2031-03-07' })).data
const dateless = (await req('/content', 'POST', { title: 'x24: staffed dateless', channels: ['instagram_main'], type: 'reel', assignees: [jas.id], operator_id: jas.id, editor_id: jas.id, status_id: shootId, recording_date: '2031-03-03', edit_ready_date: '2031-03-05', release_date: '2031-03-07' })).data
