...
// One post is one task: two finished pieces carry two addresses.
await req(`/content/${doneA.id}`, 'PATCH', { done: true, post_link: 'https://instagram.com/p/qa-recap' })
await req(`/content/${doneB.id}`, 'PATCH', { done: true, post_link: 'https://youtube.com/watch?v=qa-vlog12' })
